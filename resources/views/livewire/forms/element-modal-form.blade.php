<div>
    <div type="button" class="btn btn-sm btn-success " data-toggle="modal" wire:click.pervent="open" data-target="#elementModal">
        Create Element
    </div>

    <div wire:ignore.self class="modal fade " id="elementModal" tabindex="-1" role="dialog"  aria-hidden="true" aria-labelledby="elementModalLabel"  style="z-index: 1051;">
                    ...
                    <form  wire:submit.prevent="save">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control @error('code') is-invalid @enderror" wire:model.lazy="code"  autocomplete="code">

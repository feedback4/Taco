...
@section('content_header')
    <h1>Returns {{$return->number}} </h1>
    <a href="{{route('sales.returns.index')}}" class="btn btn-success">All Returns</a>
@stop
        ...
        <div class="row justify-content-center">
            ...
            <a href="javascript:;" onclick="window.print()" class="btn btn-sm btn-white m-b-10 p-l-5"><i
                    ...
                    <div class="invoice-header">
                        ...
                        <div class="invoice-to">
                            <small>to</small>
                            <address class="m-t-5 m-b-5">
                                <strong class="text-inverse">{{$return->client->name}}</strong><br>
                                {{$return->client->address}}<br>
                                {{$return->client->phone}}<br>
                            </address>
                        </div>
                        <div class="invoice-date">
                            <small>Return / {{$return->returned_at->format('M')}} period</small>
                            <div class="date text-inverse m-t-5">{{$return->returned}}</div>
                        ...
                        <div class="invoice-price">
                            <div class="invoice-price-left">
                                <div class="invoice-price-row">
                                    <div class="sub-price">
                                        ...
                                        <span
                                            class="text-inverse">{{$return->sub_total}} {{setting('currency')}}</span>
                                    </div>
                                    @if($return->tax_total)
                                        <div class="sub-price">
                                        ...
                                        <div class="sub-price">
                                            <small>Tax</small>
                                            <span
                                                class="text-inverse">{{ $return->tax_total }} {{setting('currency')}}</span>
                                        </div>
                                    @endif
                                    @if($return->discount)
                                        <div class="sub-price">
                                        ...
                                        <div class="sub-price">
                                            ...
                                            <span
                                                class="text-inverse">{{$return->discount}} {{setting('currency')}}</span>
                                        </div>
                                    @endif
                                </div>
                            </div>
                            <div class="invoice-price-right">
                                <small>TOTAL</small> <span
                                    class="f-w-600">{{$return->total}} {{setting('currency')}}</span>
                            </div>
                        </div>
                        <!-- end invoice-price -->
                    </div>
            ...
            <div class="col-md-6 hidden-print">
                <div class="card my-5 ">
                    <div class="card-body">
                        <h3>History</h3>
                        @forelse($return->revenues as $revenue)
                            <hr>
